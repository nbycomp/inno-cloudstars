...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("Usage: python script.py <site_id>")
        sys.exit(1)

    site_id = sys.argv[1]  # Dynamically passed site ID
    ...
    # Example of making an authenticated request with a dynamic site ID
    endpoint = f"infrastructure/sites/{site_id}"
    response = kratos_client.make_authenticated_request("GET", endpoint)
