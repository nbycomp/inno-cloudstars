...
if __name__ == "__main__":
    ...
    service_id = sys.argv[1]  # Dynamically passed service ID
    # Load credentials from JSON file
    parent_path = os.path.abspath(os.path.dirname("__file__"))

    config_file = os.path.join(parent_path, "decision_engine/config/nbi_account_info.json")
    print(config_file)
    ...
    response = kratos_client.make_authenticated_request("DELETE", f"services/{service_id}")
